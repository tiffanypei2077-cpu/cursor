...
const STR = {
  en: {
    ...
    asstPrompts: [
      { k: "practice", t: "🎬 Practice a new scenario", say: "Practice a new scenario" },
    ...
    asstContinue: "Continue previous conversation",
    asstPracticeReply: "Nice! Here are 3 you can start right now — general picks + ones for your field 👇",
    practiceHint: "Not feeling these? Shuffle, or just tell me what you'd like to practice.",
    pcGeneral: "General",
    pcVisit: "client visit",
    pcPitch: "product pitch",

    /* scenario intro + conversation (digital human) */
    sceneChars: "Dialogue characters",
    sceneAi: "AI",
    sceneYou: "You",
    sceneStart: "Start a conversation",
    finish: "Finish",
    dhInput: "Type a message or hold to talk",
    actTranslate: "Translate",
    actSlow: "Slow",
    actHint: "Hint",
    evalDims: { wording: "Wording", vocab: "Vocab", pron: "Pron", expr: "Expression" },
    evalTags: { pron: "Good pronunciation!", effort: "Good effort!", fluent: "Very natural!" },
  ...
  zh: {
    ...
    asstPrompts: [
      { k: "practice", t: "🎬 练一个新场景", say: "练一个新场景" },
      { k: "translate", t: "🌐 翻译一句话", say: "翻译一句话" },
      { k: "learn", t: "📚 今天学点什么？", say: "今天学点什么？" },
    ],
    asstField: "输入句子，或点 🎙 说话…",
    asstContinue: "继续上次的对话",
    asstPracticeReply: "好嘞！给你 3 个现在就能开练的 —— 通用 + 你行业相关的 👇",
    practiceHint: "不喜欢？点换一批，或直接告诉我你想练什么。",
    pcGeneral: "通用",
    pcVisit: "客户拜访",
    pcPitch: "产品技术介绍",
    ...
    actSlow: "慢速",
    actHint: "提示",
    evalDims: { wording: "用语", vocab: "词汇", pron: "发音", expr: "表达" },
    evalTags: { pron: "发音很棒！", effort: "表达不错！", fluent: "很自然！" },
